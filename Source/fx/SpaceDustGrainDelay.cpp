...
// Ported from Space Dust (Synth VST V2), where these expand to entries in that
// project's MemorySafetyLogger. Sol has no such logger; the macros are no-ops
// here so the rest of the file can stay byte-identical to upstream and a future
// re-port is a straight copy.
